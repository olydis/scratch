...
namespace BlobStorageTest.Client.Models
{
    ...
    public partial class BlobsLeaseHeaders
    {
        ...
        public BlobsLeaseHeaders(string eTag = default(string), string lastModified = default(string), string leaseId = default(string), int? leaseTime = default(int?), string requestId = default(string), string version = default(string), System.DateTime? date = default(System.DateTime?))
        {
            ETag = eTag;
