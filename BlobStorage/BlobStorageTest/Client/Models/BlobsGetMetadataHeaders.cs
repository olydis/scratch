...
namespace BlobStorageTest.Client.Models
{
    ...
    public partial class BlobsGetMetadataHeaders
    {
        ...
        public BlobsGetMetadataHeaders(IDictionary<string, string> metadata = default(IDictionary<string, string>), string lastModified = default(string), string eTag = default(string), string requestId = default(string), string version = default(string), System.DateTime? date = default(System.DateTime?))
        {
            Metadata = metadata;
