...
namespace BlobStorageTest.Client.Models
{
    ...
    public partial class BlobsCopyHeaders
    {
        ...
        public BlobsCopyHeaders(string eTag = default(string), string lastModified = default(string), string requestId = default(string), string version = default(string), System.DateTime? date = default(System.DateTime?), string copyId = default(string), CopyStatusType? copyStatus = default(CopyStatusType?))
        {
            ETag = eTag;
