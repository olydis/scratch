...
namespace BlobStorageTest.Client.Models
{
    ...
    public partial class ContainerSetAclHeaders
    {
        ...
        public ContainerSetAclHeaders(string eTag = default(string), string lastModified = default(string), string requestId = default(string), string version = default(string), System.DateTime? date = default(System.DateTime?))
        {
            ETag = eTag;
