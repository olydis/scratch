...
namespace BlobStorageTest.Client.Models
{
    ...
    public partial class BlobsPutHeaders
    {
        ...
        public BlobsPutHeaders(string eTag = default(string), string lastModified = default(string), string contentMD5 = default(string), string requestId = default(string), string version = default(string), System.DateTime? date = default(System.DateTime?), bool? isServerEncrypted = default(bool?))
        {
            ETag = eTag;
