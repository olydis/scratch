...
namespace BlobStorageTest.Client.Models
{
    ...
    public partial class ContainerListBlobsHeaders
    {
        ...
        public ContainerListBlobsHeaders(string contentType = default(string), string requestId = default(string), string version = default(string), System.DateTime? date = default(System.DateTime?))
        {
