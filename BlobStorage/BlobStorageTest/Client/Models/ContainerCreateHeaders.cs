...
namespace BlobStorageTest.Client.Models
{
    ...
    public partial class ContainerCreateHeaders
    {
        ...
        public ContainerCreateHeaders(string eTag = default(string), string lastModified = default(string), string requestId = default(string), string version = default(string), System.DateTime? date = default(System.DateTime?))
        {
            ETag = eTag;
