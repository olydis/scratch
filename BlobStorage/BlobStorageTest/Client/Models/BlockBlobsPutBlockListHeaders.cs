...
namespace BlobStorageTest.Client.Models
{
    ...
    /// </summary>
    public partial class BlockBlobsPutBlockListHeaders
    {
        /// <summary>
        /// Initializes a new instance of the BlockBlobsPutBlockListHeaders
        /// class.
        /// </summary>
        public BlockBlobsPutBlockListHeaders()
        {
            CustomInit();
        }
        ...
        /// true if the contents of the request are successfully encrypted
        /// using the specified algorithm, and false otherwise.</param>
        public BlockBlobsPutBlockListHeaders(string eTag = default(string), string lastModified = default(string), string contentMD5 = default(string), string requestId = default(string), string version = default(string), System.DateTime? date = default(System.DateTime?), bool? isServerEncrypted = default(bool?))
        {
            ETag = eTag;
        ...
        internal XElement XmlSerialize(XElement result)
        {
            ...
            {
                result.Add(new XElement("x-ms-request-server-encrypted", IsServerEncrypted) );
            }
            return result;
        }
        /// <summary>
        /// Deserializes an XML node to an instance of BlockBlobsPutBlockListHeaders
        /// </summary>
        internal static BlockBlobsPutBlockListHeaders XmlDeserialize(string payload)
        {
            // deserialize to xml and use the overload to do the work
            return XmlDeserialize( XElement.Parse( payload ) );
        }
        internal static BlockBlobsPutBlockListHeaders XmlDeserialize(XElement payload)
        {
            var result = new BlockBlobsPutBlockListHeaders();
            ...
            if (deserializeIsServerEncrypted(payload, "x-ms-request-server-encrypted", out resultIsServerEncrypted))
            {
