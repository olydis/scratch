...
namespace BlobStorageTest.Client.Models
{
    ...
    public partial class BlobsSetPropertiesHeaders
    {
        ...
        public BlobsSetPropertiesHeaders(string eTag = default(string), string lastModified = default(string), string xMsBlobSequenceNumber = default(string), string xMsRequestId = default(string), string xMsVersion = default(string), System.DateTime? date = default(System.DateTime?))
        {
            ETag = eTag;
