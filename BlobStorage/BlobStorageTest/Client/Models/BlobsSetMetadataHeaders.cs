...
namespace BlobStorageTest.Client.Models
{
    ...
    /// </summary>
    public partial class BlobsSetMetadataHeaders
    {
        /// <summary>
        /// Initializes a new instance of the BlobsSetMetadataHeaders class.
        /// </summary>
        public BlobsSetMetadataHeaders()
        {
            CustomInit();
        }
        ...
        public BlobsSetMetadataHeaders(string eTag = default(string), string lastModified = default(string), string requestId = default(string), string version = default(string), System.DateTime? date = default(System.DateTime?), bool? isServerEncrypted = default(bool?))
        {
            ETag = eTag;
        ...
        /// <summary>
        /// Deserializes an XML node to an instance of BlobsSetMetadataHeaders
        /// </summary>
        internal static BlobsSetMetadataHeaders XmlDeserialize(string payload)
        {
            // deserialize to xml and use the overload to do the work
            return XmlDeserialize( XElement.Parse( payload ) );
        }
        internal static BlobsSetMetadataHeaders XmlDeserialize(XElement payload)
        {
            var result = new BlobsSetMetadataHeaders();
