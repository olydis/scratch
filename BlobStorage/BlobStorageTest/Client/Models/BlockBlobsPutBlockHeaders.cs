...
namespace BlobStorageTest.Client.Models
{
    ...
    public partial class BlockBlobsPutBlockHeaders
    {
        ...
        public BlockBlobsPutBlockHeaders(string contentMD5 = default(string), string requestId = default(string), string version = default(string), System.DateTime? date = default(System.DateTime?), bool? isServerEncrypted = default(bool?))
        {
