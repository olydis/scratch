...
namespace BlobStorageTest.Client.Models
{
    ...
    public partial class PageBlobsGetPageRangesHeaders
    {
        ...
        public PageBlobsGetPageRangesHeaders(string lastModified = default(string), string eTag = default(string), int? xMsBlobContentLength = default(int?), string xMsRequestId = default(string), string xMsVersion = default(string), System.DateTime? date = default(System.DateTime?))
        {
