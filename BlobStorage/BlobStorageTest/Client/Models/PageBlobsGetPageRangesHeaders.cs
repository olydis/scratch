...
namespace BlobStorageTest.Client.Models
{
    ...
    /// </summary>
    public partial class PageBlobsGetPageRangesHeaders
    {
        /// <summary>
        /// Initializes a new instance of the PageBlobsGetPageRangesHeaders
        /// class.
        /// </summary>
        public PageBlobsGetPageRangesHeaders()
        {
            CustomInit();
        }
        ...
        /// <param name="blobContentLength">The size of the blob in
        /// bytes.</param>
        ...
        public PageBlobsGetPageRangesHeaders(string lastModified = default(string), string eTag = default(string), int? blobContentLength = default(int?), string requestId = default(string), string version = default(string), System.DateTime? date = default(System.DateTime?))
        {
        ...
        public int? BlobContentLength { get; set; }
        ...
        internal XElement XmlSerialize(XElement result)
        {
            ...
            if( null != BlobContentLength )
            {
                result.Add(new XElement("x-ms-blob-content-length", BlobContentLength) );
            }
            if( null != RequestId )
            {
        ...
        /// <summary>
        /// Deserializes an XML node to an instance of PageBlobsGetPageRangesHeaders
        /// </summary>
        internal static PageBlobsGetPageRangesHeaders XmlDeserialize(string payload)
        {
            // deserialize to xml and use the overload to do the work
            return XmlDeserialize( XElement.Parse( payload ) );
        }
        internal static PageBlobsGetPageRangesHeaders XmlDeserialize(XElement payload)
        {
            var result = new PageBlobsGetPageRangesHeaders();
            ...
            var deserializeBlobContentLength = XmlSerialization.ToDeserializer(e => (int?)e);
            int? resultBlobContentLength;
            if (deserializeBlobContentLength(payload, "x-ms-blob-content-length", out resultBlobContentLength))
            {
                result.BlobContentLength = resultBlobContentLength;
            }
