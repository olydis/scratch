...
namespace BlobStorageTest.Client.Models
{
    ...
    public partial class ContainerGetMetadataHeaders
    {
        ...
        public ContainerGetMetadataHeaders(IDictionary<string, string> metadata = default(IDictionary<string, string>), string eTag = default(string), string lastModified = default(string), string requestId = default(string), string version = default(string), System.DateTime? date = default(System.DateTime?))
        {
            Metadata = metadata;
            ETag = eTag;
