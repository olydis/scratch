...
namespace BlobStorageTest.Client.Models
{
    ...
    /// </summary>
    public partial class BlockBlobsGetBlockListHeaders
    {
        /// <summary>
        /// Initializes a new instance of the BlockBlobsGetBlockListHeaders
        /// class.
        /// </summary>
        ...
        public BlockBlobsGetBlockListHeaders(string lastModified = default(string), string eTag = default(string), string contentType = default(string), int? blobContentLength = default(int?), string requestId = default(string), string version = default(string), System.DateTime? date = default(System.DateTime?))
        {
        ...
        /// <summary>
        /// Deserializes an XML node to an instance of BlockBlobsGetBlockListHeaders
        /// </summary>
        internal static BlockBlobsGetBlockListHeaders XmlDeserialize(string payload)
        {
            // deserialize to xml and use the overload to do the work
            return XmlDeserialize( XElement.Parse( payload ) );
        }
        internal static BlockBlobsGetBlockListHeaders XmlDeserialize(XElement payload)
        {
            var result = new BlockBlobsGetBlockListHeaders();
