...
namespace BlobStorageTest.Client.Models
{
    ...
    public partial class BlobsTakeSnapshotHeaders
    {
        ...
        /// Initializes a new instance of the BlobsTakeSnapshotHeaders class.
        /// </summary>
        /// <param name="snapshot">Uniquely identifies the snapshot and
        ...
        public BlobsTakeSnapshotHeaders(string snapshot = default(string), string eTag = default(string), string lastModified = default(string), string requestId = default(string), string version = default(string), System.DateTime? date = default(System.DateTime?))
        {
            Snapshot = snapshot;
            ETag = eTag;
        ...
        internal XElement XmlSerialize(XElement result)
        {
            if( null != Snapshot )
            {
                result.Add(new XElement("x-ms-snapshot", Snapshot) );
            }
            if( null != ETag )
            {
        ...
        internal static BlobsTakeSnapshotHeaders XmlDeserialize(XElement payload)
        {
            ...
            var deserializeSnapshot = XmlSerialization.ToDeserializer(e => (string)e);
            string resultSnapshot;
            if (deserializeSnapshot(payload, "x-ms-snapshot", out resultSnapshot))
            {
