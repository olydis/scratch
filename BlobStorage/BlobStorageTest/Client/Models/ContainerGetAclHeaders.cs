...
namespace BlobStorageTest.Client.Models
{
    ...
    public partial class ContainerGetAclHeaders
    {
        ...
        public ContainerGetAclHeaders(string blobPublicAccess = default(string), string eTag = default(string), string lastModified = default(string), string requestId = default(string), string version = default(string), System.DateTime? date = default(System.DateTime?))
        {
