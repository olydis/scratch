...
namespace BlobStorageTest.Client.Models
{
    ...
    public partial class PageBlobsPutPageHeaders
    {
        ...
        public PageBlobsPutPageHeaders(string eTag = default(string), string lastModified = default(string), string contentMD5 = default(string), int? blobContentLength = default(int?), string requestId = default(string), string version = default(string), System.DateTime? date = default(System.DateTime?), bool? isServerEncrypted = default(bool?))
        {
            ETag = eTag;
