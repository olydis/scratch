...
namespace Microsoft.WindowsAzure.Storage
{
...
#endif
    {
        ...
        public StorageUri(Uri primaryUri, Uri secondaryUri)
        {
            ...
            {
                bool primaryUriPathStyle = primaryUri.HostNameType != UriHostNameType.Dns || PathStylePorts.Contains(primaryUri.Port);
                bool secondaryUriPathStyle = secondaryUri.HostNameType != UriHostNameType.Dns || PathStylePorts.Contains(secondaryUri.Port);
        ...
        private static void AssertAbsoluteUri(Uri uri)
        {
            ...
            {
                string errorMessage = string.Format(CultureInfo.InvariantCulture, "Address '{0}' is a relative address. Only absolute addresses are permitted.", uri.ToString());
