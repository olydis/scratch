...
namespace blob-storage.Models
{
    ...
    /// </summary>
    public partial class ContainerGetAclHeaders
    {
        /// <summary>
        /// Initializes a new instance of the ContainerGetAclHeaders class.
        /// </summary>
        public ContainerGetAclHeaders() { }
        ...
        public ContainerGetAclHeaders(string xMsBlobPublicAccess = default(string), string eTag = default(string), string lastModified = default(string), string xMsRequestId = default(string), string xMsVersion = default(string), System.DateTime? date = default(System.DateTime?))
        {
        ...
        /// <summary>
        /// Deserializes an XML node to an instance of ContainerGetAclHeaders
        /// </summary>
        internal static ContainerGetAclHeaders XmlDeserialize(string payload)
        {
            // deserialize to xml and use the overload to do the work
            return XmlDeserialize( XElement.Parse( payload ) );
        }
        internal static ContainerGetAclHeaders XmlDeserialize(XElement payload)
        {
            var result = new ContainerGetAclHeaders();
