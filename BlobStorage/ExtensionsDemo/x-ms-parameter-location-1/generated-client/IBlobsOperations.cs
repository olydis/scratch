...
namespace blob-storage
{
    ...
    public partial interface IBlobsOperations
    {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationHeaderResponse<BlobsAbortCopyHeaders>> AbortCopyWithHttpMessagesAsync(string accountName, string container, string blob, string copyId, int? timeout = default(int?), string leaseId = default(string), string version = "2016-05-31", Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
