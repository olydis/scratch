...
namespace blob-storage
{
    ...
    public static partial class BlockBlobsOperationsExtensions
    {
            ...
            /// </param>
            public static BlockBlobsPutBlockHeaders PutBlock(this IBlockBlobsOperations operations, string accountName, string container, string blob, string blockId, Stream body, int? timeout = default(int?), string leaseId = default(string), string version = "2016-05-31")
            {
                return operations.PutBlockAsync(accountName, container, blob, blockId, body, timeout, leaseId, version).GetAwaiter().GetResult();
            }
            ...
            /// </param>
            public static async Task<BlockBlobsPutBlockHeaders> PutBlockAsync(this IBlockBlobsOperations operations, string accountName, string container, string blob, string blockId, Stream body, int? timeout = default(int?), string leaseId = default(string), string version = "2016-05-31", CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.PutBlockWithHttpMessagesAsync(accountName, container, blob, blockId, body, timeout, leaseId, version, null, cancellationToken).ConfigureAwait(false))
                {
            ...
            {
                return operations.PutBlockListAsync(accountName, container, blob, blocks, timeout, xMsBlobCacheControl, xMsBlobContentType, xMsBlobContentEncoding, xMsBlobContentLanguage, xMsBlobContentMd5, xMsMeta, leaseId, xMsBlobContentDisposition, ifModifiedSince, ifUnmodifiedSince, ifMatches, ifNoneMatch, version).GetAwaiter().GetResult();
            }
            ...
            /// Specifies the version of the operation to use for this request.
            /// </param>
            public static BlockList GetBlockList(this IBlockBlobsOperations operations, string accountName, string container, string blob, System.DateTime? snapshot = default(System.DateTime?), BlockListType? listType = default(BlockListType?), int? timeout = default(int?), string leaseId = default(string), string version = "2016-05-31")
            {
                return operations.GetBlockListAsync(accountName, container, blob, snapshot, listType, timeout, leaseId, version).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<BlockList> GetBlockListAsync(this IBlockBlobsOperations operations, string accountName, string container, string blob, System.DateTime? snapshot = default(System.DateTime?), BlockListType? listType = default(BlockListType?), int? timeout = default(int?), string leaseId = default(string), string version = "2016-05-31", CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.GetBlockListWithHttpMessagesAsync(accountName, container, blob, snapshot, listType, timeout, leaseId, version, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
