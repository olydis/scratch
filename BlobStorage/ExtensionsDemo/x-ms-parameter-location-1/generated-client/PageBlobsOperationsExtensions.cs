...
namespace blob-storage
{
    ...
    public static partial class PageBlobsOperationsExtensions
    {
            ...
            {
                return operations.PutPageAsync(accountName, container, blob, pageWrite, body, timeout, range, leaseId, ifSequenceNumberLessThanOrEqualTo, ifSequenceNumberLessThan, ifSequenceNumberEqualTo, ifModifiedSince, ifUnmodifiedSince, ifMatches, ifNoneMatch, version).GetAwaiter().GetResult();
            }
            ...
            {
                return operations.GetPageRangesAsync(accountName, container, blob, snapshot, timeout, prevsnapshot, range, leaseId, ifModifiedSince, ifUnmodifiedSince, ifMatches, ifNoneMatch, version).GetAwaiter().GetResult();
            }
            ...
            {
                using (var _result = await operations.GetPageRangesWithHttpMessagesAsync(accountName, container, blob, snapshot, timeout, prevsnapshot, range, leaseId, ifModifiedSince, ifUnmodifiedSince, ifMatches, ifNoneMatch, version, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            {
                return operations.IncrementalCopyAsync(accountName, container, blob, copySource, timeout, xMsMeta, ifModifiedSince, ifUnmodifiedSince, ifMatches, ifNoneMatch, version).GetAwaiter().GetResult();
            }
            ...
            {
                using (var _result = await operations.IncrementalCopyWithHttpMessagesAsync(accountName, container, blob, copySource, timeout, xMsMeta, ifModifiedSince, ifUnmodifiedSince, ifMatches, ifNoneMatch, version, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Headers;
                }
            }
