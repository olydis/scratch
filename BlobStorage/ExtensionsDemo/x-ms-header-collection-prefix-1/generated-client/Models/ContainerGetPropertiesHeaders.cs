...
namespace blob-storage.Models
{
    ...
    public partial class ContainerGetPropertiesHeaders
    {
        ...
        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "x-ms-meta-foo")]
        public string XMsMetaFoo { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "x-ms-meta-bar")]
        public string XMsMetaBar { get; set; }
        ...
        internal XElement XmlSerialize(XElement result)
        {
            if( null != XMsMetaFoo )
            {
                result.Add(new XElement("x-ms-meta-foo", XMsMetaFoo) );
            }
            if( null != XMsMetaBar )
            {
                result.Add(new XElement("x-ms-meta-bar", XMsMetaBar) );
            }
            if( null != ETag )
            {
        ...
        internal static ContainerGetPropertiesHeaders XmlDeserialize(XElement payload)
        {
            ...
            var deserializeXMsMetaFoo = XmlSerialization.ToDeserializer(e => (string)e);
            string resultXMsMetaFoo;
            if (deserializeXMsMetaFoo(payload, "x-ms-meta-foo", out resultXMsMetaFoo))
            {
                result.XMsMetaFoo = resultXMsMetaFoo;
            }
            var deserializeXMsMetaBar = XmlSerialization.ToDeserializer(e => (string)e);
            string resultXMsMetaBar;
            if (deserializeXMsMetaBar(payload, "x-ms-meta-bar", out resultXMsMetaBar))
            {
                result.XMsMetaBar = resultXMsMetaBar;
            }
