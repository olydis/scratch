...
namespace blob-storage
{
    ...
    /// </summary>
    internal partial class ContainerOperations : IServiceOperations<BlobStorageClient>, IContainerOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal ContainerOperations(BlobStorageClient client)
        {
            if (client == null)
            {
