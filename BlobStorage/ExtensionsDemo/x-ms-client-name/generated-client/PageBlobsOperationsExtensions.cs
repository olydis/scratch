...
namespace blob-storage
{
    ...
    public static partial class PageBlobsOperationsExtensions
    {
            ...
            /// Specify an ETag value to operate only on blobs without a matching value.
            /// </param>
            public static PageBlobsIncrementalCopyHeaders IncrementalCopy(this IPageBlobsOperations operations, string accountName, string container, string blob, string xMsCopySource, int? timeout = default(int?), IDictionary<string, string> xMsMeta = default(IDictionary<string, string>), System.DateTime? ifModifiedSince = default(System.DateTime?), System.DateTime? ifUnmodifiedSince = default(System.DateTime?), string ifMatches = default(string), string ifNoneMatch = default(string))
            {
                return operations.IncrementalCopyAsync(accountName, container, blob, xMsCopySource, timeout, xMsMeta, ifModifiedSince, ifUnmodifiedSince, ifMatches, ifNoneMatch).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<PageBlobsIncrementalCopyHeaders> IncrementalCopyAsync(this IPageBlobsOperations operations, string accountName, string container, string blob, string xMsCopySource, int? timeout = default(int?), IDictionary<string, string> xMsMeta = default(IDictionary<string, string>), System.DateTime? ifModifiedSince = default(System.DateTime?), System.DateTime? ifUnmodifiedSince = default(System.DateTime?), string ifMatches = default(string), string ifNoneMatch = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.IncrementalCopyWithHttpMessagesAsync(accountName, container, blob, xMsCopySource, timeout, xMsMeta, ifModifiedSince, ifUnmodifiedSince, ifMatches, ifNoneMatch, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Headers;
                }
            }
