...
namespace blob-storage.Models
{
    ...
    /// </summary>
    public partial class ContainerCreateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the ContainerCreateHeaders class.
        /// </summary>
        public ContainerCreateHeaders() { }
        ...
        public ContainerCreateHeaders(string eTag = default(string), string lastModified = default(string), string xMsRequestId = default(string), string xMsVersion = default(string), System.DateTime? date = default(System.DateTime?))
        {
            ETag = eTag;
        ...
        /// <summary>
        /// Deserializes an XML node to an instance of ContainerCreateHeaders
        /// </summary>
        internal static ContainerCreateHeaders XmlDeserialize(string payload)
        {
            // deserialize to xml and use the overload to do the work
            return XmlDeserialize( XElement.Parse( payload ) );
        }
        internal static ContainerCreateHeaders XmlDeserialize(XElement payload)
        {
            var result = new ContainerCreateHeaders();
