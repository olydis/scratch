...
namespace blob-storage.Models
{
    ...
    public partial class BlobsSetMetadataHeaders
    {
        ...
        /// otherwise.</param>
        public BlobsSetMetadataHeaders(string eTag = default(string), string lastModified = default(string), string xMsRequestId = default(string), string xMsVersion = default(string), System.DateTime? date = default(System.DateTime?), bool? xMsRequestServerEncrypted = default(bool?))
        {
            ETag = eTag;
