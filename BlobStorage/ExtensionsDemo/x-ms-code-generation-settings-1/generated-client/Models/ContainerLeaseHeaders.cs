...
namespace blob-storage.Models
{
    ...
    public partial class ContainerLeaseHeaders
    {
        ...
        public ContainerLeaseHeaders(string eTag = default(string), string lastModified = default(string), string xMsLeaseId = default(string), int? xMsLeaseTime = default(int?), string xMsRequestId = default(string), string xMsVersion = default(string), System.DateTime? date = default(System.DateTime?))
        {
            ETag = eTag;
