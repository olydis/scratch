...
namespace blob-storage.Models
{
    ...
    /// </summary>
    public partial class ServiceGetStatsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the ServiceGetStatsHeaders class.
        /// </summary>
        public ServiceGetStatsHeaders() { }
        ...
        public ServiceGetStatsHeaders(string xMsRequestId = default(string), string xMsVersion = default(string), System.DateTime? date = default(System.DateTime?))
        {
        ...
        /// <summary>
        /// Deserializes an XML node to an instance of ServiceGetStatsHeaders
        /// </summary>
        internal static ServiceGetStatsHeaders XmlDeserialize(string payload)
        {
            // deserialize to xml and use the overload to do the work
            return XmlDeserialize( XElement.Parse( payload ) );
        }
        internal static ServiceGetStatsHeaders XmlDeserialize(XElement payload)
        {
            var result = new ServiceGetStatsHeaders();
