...
namespace blob-storage.Models
{
    ...
    public partial class BlobsGetPropertiesHeaders
    {
        ...
        /// <param name="xMsIncrementalCopy">Included if the blob is
        /// incremental copy blob.</param>
        ...
        public BlobsGetPropertiesHeaders(string lastModified = default(string), IDictionary<string, string> metadata = default(IDictionary<string, string>), BlobType? xMsBlobType = default(BlobType?), System.DateTime? xMsCopyCompletionTime = default(System.DateTime?), string xMsCopyStatusDescription = default(string), string xMsCopyId = default(string), string xMsCopyProgress = default(string), string xMsCopySource = default(string), CopyStatusType? xMsCopyStatus = default(CopyStatusType?), bool? xMsIncrementalCopy = default(bool?), LeaseDurationType? xMsLeaseDuration = default(LeaseDurationType?), LeaseStateType? xMsLeaseState = default(LeaseStateType?), LeaseStatusType? xMsLeaseStatus = default(LeaseStatusType?), int? contentLength = default(int?), string contentType = default(string), string eTag = default(string), string contentMD5 = default(string), string contentEncoding = default(string), string contentDisposition = default(string), string cacheControl = default(string), string xMsBlobSequenceNumber = default(string), string xMsRequestId = default(string), string xMsVersion = default(string), System.DateTime? date = default(System.DateTime?), string acceptRanges = default(string), string xMsBlobCommittedBlockCount = default(string), bool? xMsServerEncrypted = default(bool?))
        {
            ...
            XMsIncrementalCopy = xMsIncrementalCopy;
        ...
        public bool? XMsIncrementalCopy { get; set; }
        ...
        internal XElement XmlSerialize(XElement result)
        {
            ...
            if( null != XMsIncrementalCopy )
            {
                result.Add(new XElement("x-ms-incremental-copy", XMsIncrementalCopy) );
            }
        ...
        internal static BlobsGetPropertiesHeaders XmlDeserialize(XElement payload)
        {
            ...
            var deserializeXMsIncrementalCopy = XmlSerialization.ToDeserializer(e => (bool?)e);
            bool? resultXMsIncrementalCopy;
            if (deserializeXMsIncrementalCopy(payload, "x-ms-incremental-copy", out resultXMsIncrementalCopy))
            {
                result.XMsIncrementalCopy = resultXMsIncrementalCopy;
            }
