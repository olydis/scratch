...
namespace blob-storage.Models
{
    ...
    public partial class BlockBlobsPutBlockListHeaders
    {
        ...
        /// otherwise.</param>
        public BlockBlobsPutBlockListHeaders(string eTag = default(string), string lastModified = default(string), string contentMD5 = default(string), string xMsRequestId = default(string), string xMsVersion = default(string), System.DateTime? date = default(System.DateTime?), bool? xMsRequestServerEncrypted = default(bool?))
        {
            ETag = eTag;
