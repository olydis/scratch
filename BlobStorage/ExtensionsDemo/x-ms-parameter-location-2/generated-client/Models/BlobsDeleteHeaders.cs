...
namespace blob-storage.Models
{
    ...
    /// </summary>
    public partial class BlobsDeleteHeaders
    {
        /// <summary>
        /// Initializes a new instance of the BlobsDeleteHeaders class.
        /// </summary>
        public BlobsDeleteHeaders() { }
        ...
        public BlobsDeleteHeaders(string xMsRequestId = default(string), string xMsVersion = default(string), System.DateTime? date = default(System.DateTime?))
        {
        ...
        /// <summary>
        /// Deserializes an XML node to an instance of BlobsDeleteHeaders
        /// </summary>
        internal static BlobsDeleteHeaders XmlDeserialize(string payload)
        {
            // deserialize to xml and use the overload to do the work
            return XmlDeserialize( XElement.Parse( payload ) );
        }
        internal static BlobsDeleteHeaders XmlDeserialize(XElement payload)
        {
            var result = new BlobsDeleteHeaders();
