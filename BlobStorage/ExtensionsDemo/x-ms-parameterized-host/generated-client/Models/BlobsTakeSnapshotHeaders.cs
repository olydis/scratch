...
namespace blob-storage.Models
{
    ...
    /// </summary>
    public partial class BlobsTakeSnapshotHeaders
    {
        /// <summary>
        /// Initializes a new instance of the BlobsTakeSnapshotHeaders class.
        /// </summary>
        public BlobsTakeSnapshotHeaders() { }

        /// <summary>
        /// Initializes a new instance of the BlobsTakeSnapshotHeaders class.
        /// </summary>
        /// <param name="xMsSnapshot">Uniquely identifies the snapshot and
        /// indicates the snapshot version. It may be used in subsequent
        /// requests to access the snapshot</param>
        ...
        public BlobsTakeSnapshotHeaders(string xMsSnapshot = default(string), string eTag = default(string), string lastModified = default(string), string xMsRequestId = default(string), string xMsVersion = default(string), System.DateTime? date = default(System.DateTime?))
        {
        ...
        /// <summary>
        /// Gets or sets uniquely identifies the snapshot and indicates the
        /// snapshot version. It may be used in subsequent requests to access
        /// the snapshot
        /// </summary>
        [JsonProperty(PropertyName = "x-ms-snapshot")]
        ...
        internal XElement XmlSerialize(XElement result)
        {
            if( null != XMsSnapshot )
            {
                result.Add(new XElement("x-ms-snapshot", XMsSnapshot) );
            }
            if( null != ETag )
            {
        ...
        /// <summary>
        /// Deserializes an XML node to an instance of BlobsTakeSnapshotHeaders
        /// </summary>
        internal static BlobsTakeSnapshotHeaders XmlDeserialize(string payload)
        {
            // deserialize to xml and use the overload to do the work
            return XmlDeserialize( XElement.Parse( payload ) );
        }
        internal static BlobsTakeSnapshotHeaders XmlDeserialize(XElement payload)
        {
            var result = new BlobsTakeSnapshotHeaders();
            var deserializeXMsSnapshot = XmlSerialization.ToDeserializer(e => (string)e);
            string resultXMsSnapshot;
            if (deserializeXMsSnapshot(payload, "x-ms-snapshot", out resultXMsSnapshot))
            {
                result.XMsSnapshot = resultXMsSnapshot;
            }
