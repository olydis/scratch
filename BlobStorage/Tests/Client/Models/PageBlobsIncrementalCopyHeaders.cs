...
namespace BlobStorageTest.Client.Models
{
    ...
    public partial class PageBlobsIncrementalCopyHeaders
    {
        ...
        public PageBlobsIncrementalCopyHeaders(string eTag = default(string), string lastModified = default(string), string xMsRequestId = default(string), string xMsVersion = default(string), System.DateTime? date = default(System.DateTime?), string xMsCopyId = default(string), CopyStatusType? xMsCopyStatus = default(CopyStatusType?))
        {
            ETag = eTag;
