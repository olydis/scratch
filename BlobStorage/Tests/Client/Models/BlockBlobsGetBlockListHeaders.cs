...
namespace BlobStorageTest.Client.Models
{
    ...
    public partial class BlockBlobsGetBlockListHeaders
    {
        ...
        public BlockBlobsGetBlockListHeaders(string lastModified = default(string), string eTag = default(string), string contentType = default(string), int? xMsBlobContentLength = default(int?), string xMsRequestId = default(string), string xMsVersion = default(string), System.DateTime? date = default(System.DateTime?))
        {
