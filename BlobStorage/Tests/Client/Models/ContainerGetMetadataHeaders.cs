...
namespace BlobStorageTest.Client.Models
{
    ...
    /// </summary>
    public partial class ContainerGetMetadataHeaders
    {
        /// <summary>
        /// Initializes a new instance of the ContainerGetMetadataHeaders
        /// class.
        /// </summary>
        public ContainerGetMetadataHeaders() { }
        ...
        public ContainerGetMetadataHeaders(IDictionary<string, string> metadata = default(IDictionary<string, string>), string eTag = default(string), string lastModified = default(string), string xMsRequestId = default(string), string xMsVersion = default(string), System.DateTime? date = default(System.DateTime?))
        {
            Metadata = metadata;
            ETag = eTag;
        ...
        /// <summary>
        /// Deserializes an XML node to an instance of ContainerGetMetadataHeaders
        /// </summary>
        internal static ContainerGetMetadataHeaders XmlDeserialize(string payload)
        {
            // deserialize to xml and use the overload to do the work
            return XmlDeserialize( XElement.Parse( payload ) );
        }
        internal static ContainerGetMetadataHeaders XmlDeserialize(XElement payload)
        {
            var result = new ContainerGetMetadataHeaders();
