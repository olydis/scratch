...
namespace BlobStorageTest.Client.Models
{
    ...
    /// </summary>
    public partial class ContainerSetAclHeaders
    {
        /// <summary>
        /// Initializes a new instance of the ContainerSetAclHeaders class.
        /// </summary>
        public ContainerSetAclHeaders() { }
        ...
        public ContainerSetAclHeaders(string eTag = default(string), string lastModified = default(string), string xMsRequestId = default(string), string xMsVersion = default(string), System.DateTime? date = default(System.DateTime?))
        {
            ETag = eTag;
        ...
        /// <summary>
        /// Deserializes an XML node to an instance of ContainerSetAclHeaders
        /// </summary>
        internal static ContainerSetAclHeaders XmlDeserialize(string payload)
        {
            // deserialize to xml and use the overload to do the work
            return XmlDeserialize( XElement.Parse( payload ) );
        }
        internal static ContainerSetAclHeaders XmlDeserialize(XElement payload)
        {
            var result = new ContainerSetAclHeaders();
